...
const project = new AwsCdkTypeScriptApp({
  ...
  authorUrl: 'https://www.cloudgardener.dev/' /* Author's URL / Website. */,
  ...
  devDeps: ['prettier', 'esbuild@0'] /* Build dependencies for this module. */,
  ...
  repository:
    'https://github.com/nikovirtala/notes-backend' /* The repository is the location where the actual code for your package lives. */,
  ...
  dependabotOptions: { scheduleInterval: 'weekly' } /* Options for dependabot. */,
